var shelves = [
  ['Movies', 404, 'https://letterboxd.com/tinyhomecinema/list/movies-shelf/', 'shelf'],
  ['TV Shows', 7, 'https://www.themoviedb.org/list/8283859-tv-shows-shelf', 'shelf'],
  ['Music', 35, 'https://tinyhomecinema.page/music/', 'shelf'],
  ['Books', 35, 'https://www.librarything.com/catalog.php?view=hpfilho&collection=794026&shelf=shelf&sort=title&previousOffset=0&shelf_rows=3&collection=794026', 'shelf']
]

var collection = [
  ['Films', 339, 'https://letterboxd.com/tinyhomecinema/list/film-collection/', 'collection'],
